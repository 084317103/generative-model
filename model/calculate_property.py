...
if __name__ == '__main__':
    ...
    #file_path = 'autodl-tmp/QBMG/data/inhibitor2_filtered.txt'
    #file_path = 'autodl-tmp/QBMG/data/zinc250k_filtered.txt'
    ...
    property_df.to_csv('sample_augument3_standard_unique_novel_with_property.csv', index=False)
    #property_df.to_csv('autodl-tmp/QBMG/inhibitor2_property.csv', index=False)
    #property_df.to_csv('autodl-tmp/QBMG/zinc250k_filtered_property.csv', index=False)